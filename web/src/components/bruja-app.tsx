      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-6">
        <section className="rounded-[32px] border border-white/80 bg-white/80 p-6 shadow-[0_20px_70px_rgba(15,23,42,0.08)] backdrop-blur sm:p-8">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl space-y-3">
              ...
              <h1 className="text-3xl font-black sm:text-4xl">Una experiencia de apoyo, magia y cuidado hecha para iOS y web.</h1>
              <p className="text-base text-slate-600">
                Esta primera pasada recrea el corazón de la app: perfiles personales, males y una guía cálida para sanar.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-900 px-5 py-4 text-sm text-white shadow-lg">
              <p className="font-semibold">Perfil activo</p>
              <p className="mt-1 text-slate-300">{activeProfile ? activeProfile.name : "Sin perfil todavía"}</p>
            </div>
          </div>
        </section>
        ...
        <section className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_16px_50px_rgba(15,23,42,0.06)]">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-600 text-xl text-white shadow-lg">
                ✨
              </div>
            </div>
            ...
            <div className="mt-6 rounded-[24px] border border-slate-200 bg-slate-50 p-5">
              <h3 className="text-lg font-semibold">Crear nuevo perfil</h3>
              <input
        ...
        <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-[0_16px_50px_rgba(15,23,42,0.06)]">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h2 className="text-2xl font-bold">Próximo paso</h2>
              <p className="mt-2 text-slate-600">El siguiente bloque será convertir esta vista en una experiencia más parecida a la app original con navegación por pantallas y más detalle visual.</p>
            </div>
